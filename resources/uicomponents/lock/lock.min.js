...
{};b.DocumentLock.get=function(a){a=c(a);a=new b.DocumentReference(a.wiki,a.space,a.page);return b.DocumentLock._instances[b.Model.serialize(a)]};var d=function(){b.EditLock=new b.DocumentLock;b.editor&&b.EditLock.lock();return!0};b.domIsLoaded&&d()||document.observe("xwiki:dom:loaded",d);return b}(XWiki||{});
