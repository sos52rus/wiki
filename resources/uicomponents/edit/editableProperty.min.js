...
{new XWiki.widgets.Notification(f["web.editableProperty.viewFailed"],"error");return Promise.reject()})}});require(["jquery","editableProperty","xwiki-events-bridge"],function(b){var g=function(l,h){b(h&&h.elements||document).find("dt.editableProperty").editableProperty()};b(document).on("xwiki:dom:updated",g);b(g)})}).apply("",[{"edit":"Редактировать","cancel":"Отмена","save":"Сохранить","core.editors.saveandcontinue.notification.inprogress":"Сохранение...","core.editors.saveandcontinue.notification.done":"Сохранено","core.editors.saveandcontinue.notification.error":"Не удалось сохранить документ. Причина: <span id=\"saveFailureReason\"><\/span>","web.editableProperty.editFailed":"Не удалось изменить свойство.","web.editableProperty.viewFailed":"Не удалось просмотреть свойство."},{"pencil":"<span class=\"fa fa-pencil\" aria-hidden=\"true\"><\/span>","cross":"<span class=\"fa fa-times\" aria-hidden=\"true\"><\/span>","check":"<span class=\"fa fa-check\" aria-hidden=\"true\"><\/span>"}]);
