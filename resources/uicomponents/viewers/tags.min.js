...
new c.widgets.Suggest(a.down("input[type=text]"),{script:"http://xwiki.st.tech/bin/view/Main/?xpage=suggest&classname=XWiki.TagClass&fieldname=tags&firCol=-&secCol=-&",parentContainer:"tag-add-form-suggest",varname:"input",seps:"|,",shownoresults:!1,icon:"../../../../../../../../../resources/icons/silk/tag_yellow.png"})}});c.domIsLoaded&&g()||document.observe("xwiki:dom:loaded",g);return c}(XWiki||{});
