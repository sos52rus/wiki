...
1;d=$(d||"body");if(d="xwikicontent"==d.id?d:d.down("#xwikicontent")){d=d.childNodes;for(var c=new RegExp("H[1-"+2+"]"),e=0;e<d.length;e++){var g=$(d[e]);if(c.test(g.nodeName)&&!g.classList.contains("wikigeneratedheader")&&!g.down("a.edit_section")){var f=document.createElement("a");f.className="edit_section";f.toggle(g.visible()&&!g.hasClassName("hidden"));f.setAttribute("role","button");f.title="Редактировать";f.innerHTML=
"<span class=\"fa fa-pencil\" aria-hidden=\"true\"><\/span>";var h=document.createElement("span");h.className="sr-only";h.textContent="Редактировать";f.appendChild(h);b.hasRenderer?(h=document.documentElement.getAttribute("data-xwiki-form-token"),f.href=window.docediturl+"?section="+a+"&form_token="+h):(f.className+=" disabled",f.setAttribute("aria-disabled","true"),f.setAttribute("tabindex","-1"),f.title="Синтаксис этой страницы не поддерживает редактирование раздела!",
...
[{"js":{"xwiki-suggestPages":"..\/..\/..\/..\/..\/..\/..\/..\/..\/resources\/uicomponents\/suggest\/suggestPages.min.js"},"css":{"selectize":["..\/..\/..\/webjars\/selectize.js\/0.13.3\/css\/selectize.bootstrap3.css","..\/..\/..\/..\/..\/..\/..\/..\/..\/resources\/uicomponents\/suggest\/xwiki.selectize.min.css"]}},{"inputTooltip":"Раздел.Документ","viewLabel":"Просмотреть","viewTooltip":"Просмотр документа (Enter)","editLabel":"Редактировать","editTooltip":"Редактировать документ в редакторе по умолчанию (Meta+E)","content":"Перейти к:"},{"show":["Meta+G","Ctrl+G","Ctrl+\/","Meta+\/"],"view":["Enter"],"edit":["Meta+E"]}]);"undefined"==typeof XWiki||"undefined"==typeof XWiki.widgets||"undefined"==typeof XWiki.widgets.ModalPopup?"undefined"!=typeof console&&"function"==typeof console.warn&&console.warn("[ConfirmationBox widget] Required class missing: XWiki.widgets.ModalPopup"):XWiki.widgets.ConfirmationBox=Class.create(XWiki.widgets.ModalPopup,{defaultInteractionParameters:{confirmationText:"Вы уверены?",yesButtonText:"Да",
noButtonText:"Нет",cancelButtonText:"Отмена",showCancelButton:!1},initialize:function($super,d,a){this.interactionParameters=Object.extend(Object.clone(this.defaultInteractionParameters),a||{});a={show:{method:this.showDialog,keys:[]},yes:{method:this.onYes,keys:["Enter","Space","y"]},no:{method:this.onNo,keys:["n"]},close:{method:this.closeDialog,keys:["c"]}};this.interactionParameters.showCancelButton?
...
progressMessageText:"Запрос отправлен на сервер...",displaySuccessMessage:!0,successMessageText:"Сделано!",displayFailureMessage:!0,failureMessageText:"Ошибка:"},c||{});this.requestUrl=d;this.ajaxRequestParameters=Object.extend(Object.clone(this.defaultAjaxRequestParameters),a||{});Object.extend(this.ajaxRequestParameters,
...
resultId:"id",resultValue:"value",resultInfo:"info",resultInfoHTML:!1,resultIcon:"icon",resultHint:"hint",resultType:"type",resultURL:"url",parentContainer:"body",highlight:!0,fadeOnClear:!0,hideButton:{positions:["top"],text:"\u0421\u043F\u0440\u044F\u0442\u0430\u0442\u044C \u043F\u0440\u0435\u0434\u043B\u043E\u0436\u0435\u043D\u0438\u044F"},insertBeforeSuggestions:null,displayValue:!1,displayValueText:"Значение:",align:"left",unifiedLoader:!1,loaderNode:null,propagateEventKeyCodes:[]},
